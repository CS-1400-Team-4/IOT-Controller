...
public abstract class IOTController {
    ...
    public static Map<IOTDevice, String> devices = new HashMap<>();
    public static Scanner scanner = new Scanner(System.in);

    public static void main(String[] args) {
        devices.put(BLINDS, "Blinds");
        devices.put(HEATER, "Heater");
        devices.put(AC, "A/C");
        devices.put(LIGHTS, "Lights");
        ...
        do {
            ...
            for (var device : devices.entrySet()) {
                boolean isActive = device.getKey().isActive(currentState, previousState);
                System.out.println("Device (" + device.getValue() + ") is " + (isActive ? "active" : "inactive"));
            }
